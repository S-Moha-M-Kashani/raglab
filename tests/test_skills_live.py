...
which is what puts the button beside the function at all.
    ...
    uv run pytest tests/test_skills_live.py -v -s

`tests/test_skills.py` holds the offline coverage; this file holds the one
...
from raglab.clichat import CliChat, cli_available
from raglab.settings import load_env_file
