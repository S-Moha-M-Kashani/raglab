...
if __package__ in (None, ''):
    ...
    __package__ = 'raglab.agents.widget'

from raglab.configuration.env_settings import load_env_file
from raglab.agents.widget import hooks
from raglab.agents.widget.backends import DEFAULT_MODEL, WIDGET_MODELS, ask
from raglab.agents.widget.hooks import HOOK_LOG
