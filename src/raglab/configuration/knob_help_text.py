...
HELP = {
    ...
    'run.dataset-file': (
        ...
        '[{"text": "…"}]}] — one entry per document, one part per segment of '
        'it; a label used anywhere (on a document, a part, a question) must be '
    ...
    'index.embedder': (
        ...
        'Farsi-tuned one, say, for a Farsi corpus. It needs the '
    ...
    'index.embed_model': (
        ...
        'a corpus need not be English — the bundled set alone spans Farsi, '
        'German and English — so every entry states its coverage and '
    ...
    'retrieval.time_filter': (
        ...
        'retrieving the whole corpus. A question in any other language matches '
